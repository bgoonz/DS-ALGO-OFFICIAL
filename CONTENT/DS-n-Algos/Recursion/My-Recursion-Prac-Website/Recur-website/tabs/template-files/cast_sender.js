( function () {
  ...
  */
  ...
  var t = function ( a, c ) {
    a = a.split( "%s" );
    for ( var e = "", b = a.length - 1, g = 0; g < b; g++ ) e += a[ g ] + ( g < c.length ? c[ g ] : "%s" );
    r.call( this, e + a[ b ] )
  };
  p( t, r );
  ...
  var z = function ( a ) {
    ...
    B = function ( a, c, e ) {
      ...
      if ( f && "undefined" != typeof f.HTMLScriptElement && ( !b || !( b instanceof f.HTMLScriptElement ) && ( b instanceof f.Location || b instanceof f.Element ) ) ) {
        f = typeof b;
        if ( "object" == f && null != b || "function" ==
          f ) try {
          var d = b.constructor.displayName || b.constructor.name || Object.prototype.toString.call( b )
        } catch ( x ) {
          d = "<object could not be stringified>"
        } else d = void 0 === b ? "undefined" : null === b ? "null" : typeof b;
        u( "Argument is not a %s (or a non-Element, non-Location mock); got: %s", "HTMLScriptElement", d )
      }
      a instanceof y && a.constructor === y ? d = a.g : ( d = typeof a, u( "expected object of type TrustedResourceUrl, got '" + a + "' of type " + ( "object" != d ? d : a ? Array.isArray( a ) ? "array" : d : "null" ) ), d = "type_error:TrustedResourceUrl" );
      b.src =
        d;
      ( d = b.ownerDocument && b.ownerDocument.defaultView ) && d != h ? d = n( d.document ) : ( null === m && ( m = n( h.document ) ), d = m );
    ...
    H = [ "pkedcjkdefgpdelpbcmbmeomcjbeemfm",
  ...
  if ( 0 <= window.navigator.userAgent.indexOf( "Android" ) && 0 <= window.navigator.userAgent.indexOf( "Chrome/" ) && window.navigator.presentation ) {
    G();
    var I, J = window.navigator.userAgent.match( /Chrome\/([0-9]+)/ );
    ...
    C( K )
  } else !window.chrome || !window.navigator.presentation || 0 <= window.navigator.userAgent.indexOf( "Edge" ) ?
    D() : ( G(), C( H.map( E ) ) );
} ).call( this );
