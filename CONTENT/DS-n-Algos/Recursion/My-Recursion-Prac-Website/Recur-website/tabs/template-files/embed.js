( function ( g ) {
  ...
  var P2 = function ( a, b ) {
    ...
    Q2 = function ( a, b ) {
      var c = b.pop();
      for ( c = a.l + a.i.length() - c; 127 < c; ) b.push( c & 127 | 128 ), c >>>= 7, a.l++;
      b.push( c );
      a.l++
    },
    oGa = function ( a, b, c ) {
      null != c && ( g.kf( a.i, 8 * b + 1 ), a = a.i, b = c >>> 0, c = Math.floor( ( c - b ) / 4294967296 ) >>> 0, g.vf = b, g.wf = c, g.lf( a, g.vf ), g.lf( a, g.wf ) )
    },
    R2 = function ( a, b, c ) {
        ...
        for ( var d = a.i, e = 0; e < c.length; e++ ) {
          ...
          if ( 128 > f ) d.i.push( f );
            ...
            if ( 55296 <= f && 56319 >= f && e + 1 < c.length ) {
              ...
              56320 <= h && 57343 >= h && ( f = 1024 * ( f - 55296 ) + h - 56320 + 65536, d.i.push( f >> 18 | 240 ), d.i.push( f >> 12 & 63 | 128 ), d.i.push( f >> 6 & 63 | 128 ), d.i.push( f & 63 | 128 ), e++ )
            } else d.i.push( f >> 12 | 224 ), d.i.push( f >> 6 & 63 | 128 ), d.i.push( f & 63 | 128 )
        }
        Q2( a, b )
      }
    },
    ...
    pGa = function ( a, b ) {
      ...
      for ( h = 0; 1E-6 < Math.abs( f - b ) && 8 > h; h++ ) f < b ? ( d = c, c = ( c + e ) / 2 ) : ( e = c, c = ( c + d ) / 2 ), f = g.Cn( a, c );
      return c
    },
    V2 = function ( a, b, c ) {
      a.i || ( a.i = {} );
    ...
    W2 = function ( a, b, c, d ) {
      ( c = g.Df( a, c ) ) && c !== b && void 0 !== d && ( a.i && c in a.i && ( a.i[ c ] = void 0 ), g.Hf( a, c, void 0 ) );
      g.Hf( a, b, d )
    },
    X2 = function () {
      return {
    ...
    wGa = function () {
      if ( !$2 ) {
        $2 = new tGa;
        var a = g.Qo( "client_streamz_web_flush_count", -1 ); - 1 !== a && ( $2.B = a )
      }
      this.i = $2;
      this.i.uK( "/client_streamz/youtube/web/debug/third_party_apisid_cookie_reissue_iframe", {
        XK: 3,
        WK: "client_name"
      } )
    },
    ...
    f3 = function ( a ) {
      g.I.call( this );
      this.callback = a;
      this.u = new g.Bn( 0, 0, .4, 0, .2, 1, 1, 1 );
    ...
    PGa = function ( a ) {
      for ( var b = 0; b < a.i.length; b++ ) {
        ...
        g.zn.test( d.title ) ? h.dir = "rtl" : g.kCa.test( d.title ) && ( h.dir = "ltr" );
        h = c.ha( "ytp-suggestion-author" );
        g.zn.test( e ) ? h.dir = "rtl" : g.kCa.test( e ) && ( h.dir = "ltr" );
        h = d.isLivePlayback ? "Live" : d.lengthSeconds ? g.YL( d.lengthSeconds ) : "";
        c.update( {
          views_or_author: e,
          duration: h,
          link: f,
    ...
    RGa = function ( a, b ) {
      var c;
      b.reason && ( j3( b.reason ) ? c = g.VF( b.reason ) : c = g.fO( g.U( b.reason ) ), a.Fc( c, "content" ) );
      var d;
      b.subreason && ( j3( b.subreason ) ? d = g.VF( b.subreason ) : d = g.fO( g.U( b.subreason ) ), a.Fc( d, "subreason" ) );
      if ( b.proceedButton && b.proceedButton.buttonRenderer ) {
        ...
        if ( e.text && e.text.simpleText ) {
          ...
          d.textContent = f;
          a: {
            for ( var h = ( c || document ).getElementsByTagName( "A" ), l = 0; l < h.length; l++ )
    ...
    n3 = function ( a, b ) {
      ...
      g.K( this, this.I );
      var d = a.T();
      "0" === d.controlsType && g.M( a.getRootNode(), "ytp-pause-overlay-controls-hidden" );
      this.X = d.l;
      g.K( this, this.title );
      this.title.fa( this.element );
      this.suggestions = new g.W( {
    ...
    SGa = function ( a ) {
      for ( var b = 0; b < a.i.length; b++ ) {
        ...
        var f = c.isLivePlayback ? "Live" : c.lengthSeconds ? g.YL( c.lengthSeconds ) : "";
        var h = c.ul();
      ...
      for ( ; b < a.B.length; b++ ) a.B[ b ].element.style.display =
        "none";
      o3( a )
    },
    p3 = function ( a ) {
  ...
  g.k.kJ = function ( a, b, c ) {
    ...
    ( e = uGa( this, a ) ) && e instanceof Z2 && ( e.u( b, d ), this.i.enabled || this.i.start(), this.u++, this.u >= this.B && this.LG() )
  };
  ...
  g.k.nJ = function ( a, b ) {
    var c = this.i[ a ],
      d = c.Bd;
    g.$N( b, this.api, this.X, d || void 0 ) && this.api.Fi( c.Na().videoId, d, c.getPlaylistId() )
  };
  g.k.resize = function ( a, b ) {
    ...
    if ( 150 >= Math.min( a.width, a.height ) || 0 === h || !c.Xa ) this.hide();
      ...
      b && r + 100 > b && 50 < m && ( r = Math.max( b, 50 / d ), m = Math.ceil( l / ( d * ( r - 100 ) + this.l ) ), m = l / m - this.l, r = Math.floor( m /
        d ) );
  ...
  i3.prototype.l = function ( a ) {
    ...
    if ( g.S( this.api.T().experiments, "embed_parse_error_renderer_killswitch" ) || !b.DH && !b.playerErrorMessageRenderer ) {
      var c;
      a.Wi && ( b.em ? j3( b.em ) ? c = g.VF( b.em ) : c = g.fO( g.U( b.em ) ) : c = g.fO( a.Wi ), this.Fc( c, "subreason" ) )
    } else( a = b.DH ) ? RGa( this, a ) : b.playerErrorMessageRenderer && RGa( this, b.playerErrorMessageRenderer )
  };
  g.u( k3, g.W );
  ...
  k3.prototype.i = function () {
    ...
    b = !b.Xa;
    var e = this.l.Me();
    d || e || c || b || !a.videoId ? ( this.hide(), this.api.Qa( this.element, !1 ) ) : ( a = g.Id( this.api.getVideoUrl(), g.EO( "emb_imp_woyt" ) ), this.Aa( "url", a ), this.show() )
  };
  ...
  k3.prototype.show = function () {
    this.api.Va().isCued() && ( g.W.prototype.show.call( this ), this.api.fr( this.element ) && this.api.Qa( this.element, !0 ) )
  };
  g.u( l3, g.W );
  l3.prototype.l = function () {
    var a = this.api.Va(),
      b = this.api.getVideoData();
    g.S( this.api.T().experiments, "embeds_enable_muted_autoplay" ) && b.mutedAutoplay && ( g.V( a, 2 ) && !this.ab ? ( this.show(), this.i.show(), a = this.api.getVideoData(), this.Aa( "text", a.LB ), g.N( this.element, "ytp-muted-autoplay-show-end-panel", !0 ), this.api.Qa( this.element, this.ab ), this.api.xa( "onMutedAutoplayEnds" ) ) : this.hide() )
  };
  ...
  m3.prototype.i = function () {
    var a = this.api.Va(),
      b = this.api.getVideoData();
    g.S( this.api.T().experiments, "embeds_enable_muted_autoplay" ) && b.mutedAutoplay && !g.V( a, 2 ) ? this.ab || ( g.W.prototype.show.call( this ), this.u.start(), this.api.Qa( this.element, this.ab ) ) : this.hide()
  };
  ...
  g.k.Xb = function ( a ) {
    if ( !( g.V( a.state, 1 ) || g.V( a.state, 16 ) || g.V( a.state, 32 ) ) ) {
      var b = !g.S( this.api.T().experiments, "embeds_disable_pauseoverlay_on_autoplay_blocked_killswitch" ) && g.V( a.state, 2048 );
      !g.V( a.state, 4 ) || g.V( a.state, 2 ) || b ? this.I.hide() : this.i.length && ( this.J || ( g.M( this.api.getRootNode(), "ytp-expand-pause-overlay" ), o3( this ) ), this.I.show(), this.ea = ( 0, g.P )() )
    }
  };
  g.k.Sa = function ( a ) {
    var b = 16 / 9,
  ...
  g.k.AA = function () {
    var a = this.api.getVideoData(),
      ...
      c = this.api.T();
    a = ( a.mutedAutoplay || c.kb && !g.V( this.state, 2 ) ) && !( b && c.pfpChazalUi );
    g.rL( this, a );
  ...
  g.k.create = function () {
    var a = this.G.T(),
      b = g.nN( this.G );
    a.Xa && ( this.C = new n3( this.G, b ), g.K( this, this.C ), g.xN( this.G, this.C.element, 4 ) );
    g.S( a.experiments, "embeds_enable_muted_autoplay" ) && ( this.i = new m3( this.G ), g.K( this, this.i ), g.xN( this.G, this.i.element, 4 ), this.B = new l3( this.G ), g.K( this, this.B ), g.xN( this.G, this.B.element, 4 ) );
    if ( a.kb || this.i ) this.watermark = new p3( this.G ), g.K( this, this.watermark ), g.xN( this.G, this.watermark.element, 7 );
    g.S( a.experiments, "embeds_impression_link" ) && ( this.u = new k3( this.G, b ),
      g.K( this, this.u ), g.xN( this.G, this.u.element, 7 ) );
    ...
    g.S( a.experiments, "enable_cookie_reissue_iframe" ) && a.Ef && !g.Sq( "__Secure-3PAPISID" ) && ( a = a.deviceParams.c, a = void 0 === a ? "WEB" : a, ( new wGa ).i.jJ( "/client_streamz/youtube/web/debug/third_party_apisid_cookie_reissue_iframe", a ), a = g.Ce( "IFRAME" ),
  ...
  g.k.tb = function ( a ) {
    g.V( a, 128 ) ? ( this.Qd || ( this.Qd = new i3( this.G ), g.K( this, this.Qd ), g.xN( this.G, this.Qd.element, 4 ) ), this.Qd.l( a.getData() ), this.Qd.show(), g.M( this.G.getRootNode(), "ytp-embed-error" ) ) : this.Qd && ( this.Qd.dispose(), this.Qd = null, g.rn( this.G.getRootNode(), "ytp-embed-error" ) )
  };
  g.k.YN = function () {
    this.G.getVideoData().mutedAutoplay && this.i && this.watermark && this.watermark.fa( this.i.bottomButtons, 0 )
  };
  g.k.ZQ = function () {
    var a = this.G.getVideoData();
    this.watermark && this.i && !a.mutedAutoplay && g.Je( this.i.element, this.watermark.element ) && g.xN( this.G, this.watermark.element, 7 )
  };
  g.NN.embed = q3;
} )( _yt_player );
