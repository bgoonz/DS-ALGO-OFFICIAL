...
def test_string_formatting():
    ...
    assert (
        repr((first_num, second_num, ("spam", "eggs")))
    ...
    assert (
        'We are {} who say "{}!"'.format("knights", "Ni")
    ...
    formatted_string = "Jack: {0[Jack]:d}; Sjoerd: {0[Sjoerd]:d}; Dcab: {0[Dcab]:d}".format(
        table
    )
    ...
    formatted_string = "Jack: {Jack:d}; Sjoerd: {Sjoerd:d}; Dcab: {Dcab:d}".format(
        **table
    )
