...
g.k.QP=function(){var a=m5(this.De),b=o5(this.De);this.Bs<b.length&&(i5(this),zIa(this,a,b),this.zi&&4!=a&&c5(this))};
...
g.k.zP=function(){this.Ip=null;var a=g.C();0<=a-this.CA?(2!=this.Cp&&this.i.ji(3),f5(this),this.Nk=2,Z4(18),g5(this)):CIa(this,this.CA-a)};
g.k.getLastError=function(){return this.Nk};g.Ra(k5,g.am);var JIa=/^https?$/i,BKa=["POST","PUT"];g.k=k5.prototype;
g.k.send=function(a,b,c,d){if(this.i)throw Error("[goog.net.XhrIo] Object is active with another request="+this.W+"; newUri="+a);b=b?b.toUpperCase():"GET";this.W=a;this.u="";this.I=0;this.za=b;this.ga=!1;this.B=!0;this.i=this.ea?uIa(this.ea):uIa(u7);this.ca=this.ea?this.ea.getOptions():u7.getOptions();this.i.onreadystatechange=(0,g.B)(this.DF,this);try{y4(n5(this,"Opening Xhr")),this.la=!0,this.i.open(b,String(a),!0),this.la=!1}catch(f){y4(n5(this,"Error opening Xhr: "+f.message));IIa(this,f);return}a=
c||"";var e=this.headers.clone();d&&QHa(d,function(f,h){e.set(h,f)});
d=g.$a(e.uh(),GIa);c=g.A.FormData&&a instanceof g.A.FormData;!g.db(BKa,b)||d||c||e.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");e.forEach(function(f,h){this.i.setRequestHeader(h,f)},this);
this.Da&&(this.i.responseType=this.Da);"withCredentials"in this.i&&this.i.withCredentials!==this.ia&&(this.i.withCredentials=this.ia);try{LIa(this),0<this.J&&(this.Y=FIa(this.i),y4(n5(this,"Will abort after "+this.J+"ms if incomplete, xhr2 "+this.Y)),this.Y?(this.i.timeout=this.J,this.i.ontimeout=(0,g.B)(this.AB,this)):this.X=g.Lm(this.AB,this.J,this)),y4(n5(this,"Sending request")),this.L=!0,this.i.send(a),this.L=!1}catch(f){y4(n5(this,"Send error: "+f.message)),IIa(this,f)}};
...
g.k.DF=function(){this.na()||(this.la||this.L||this.C?KIa(this):this.yO())};
g.k.yO=function(){KIa(this)};
...
g.k.getLastError=function(){return"string"===typeof this.u?this.u:String(this.u)};g.k=MIa.prototype;g.k.pw=null;g.k.Dg=null;g.k.Nu=!1;g.k.PG=null;g.k.ut=null;g.k.Ky=null;g.k.qw=null;g.k.Ma=null;g.k.Oj=-1;g.k.aq=null;g.k.kq=null;g.k.connect=function(a){this.qw=a;a=p5(this.i,null,this.qw);Z4(3);this.PG=g.C();var b=this.i.J;null!=b?(this.aq=b[0],(this.kq=b[1])?(this.Ma=1,NIa(this)):(this.Ma=2,r5(this))):(w4(a,"MODE","init"),this.Dg=new a5(this,void 0,void 0,void 0),this.Dg.km=this.pw,b5(this.Dg,a,!1,null,!0),this.Ma=0)};
...
g.k.FQ=function(a){a?Z4(2):(Z4(1),aJa(this,8))};
...
g.k.ji=function(a){var b=Y4;b.dispatchEvent(new QIa(b,a))};
g.k.Wr=function(){return!(!g.ve||g.Yd(10))};
g.k=bJa.prototype;g.k.EC=function(){};
g.k.DC=function(){};
g.k.CC=function(){};
g.k.bx=function(){};
g.k.mD=function(){return{}};
g.k.isActive=function(){return!0};g.k=cJa.prototype;g.k.isEmpty=function(){return g.eb(this.i)&&g.eb(this.l)};
...
g.k.isActive=function(){return this.i.isActive()};
g.k.reset=function(){this.i.stop();this.If=5E3};g.Ra(A5,bJa);g.k=A5.prototype;g.k.subscribe=function(a,b,c){return this.u.subscribe(a,b,c)};
...
g.k.dispose=function(){this.X||(this.X=!0,g.Ni(this.u),fJa(this),g.Ni(this.l),this.l=null,this.Y=function(){return""})};
g.k.na=function(){return this.X};
g.k.connect=function(a,b,c){if(!this.i||2!=this.i.getState()){this.W="";this.l.stop();this.C=a||null;this.B=b||0;a=this.ca+"/test";b=this.ca+"/bind";var d=new s5(c?c.firstTestResults:null,c?c.secondTestResults:null,this.ea),e=this.i;e&&(e.yf=null);d.yf=this;this.i=d;B5(this);if(this.i){d=g.O("ID_TOKEN");var f=this.i.Ji||{};d?f["x-youtube-identity-token"]=d:delete f["x-youtube-identity-token"];this.i.Ji=f}e?(3!=e.getState()&&0==WIa(e)||e.getState(),this.i.connect(a,b,this.I,e.l,e.Ro)):c?this.i.connect(a,
b,this.I,c.sessionId,c.arrayId):this.i.connect(a,b,this.I)}};
g.k.sendMessage=function(a,b){var c={_sc:a};b&&g.Tb(c,b);this.l.isActive()||2==(this.i?this.i.getState():0)?this.J.push(c):C5(this)&&(B5(this),VIa(this.i,c))};
g.k.EC=function(){this.l.reset();this.C=null;this.B=0;if(this.J.length){var a=this.J;this.J=[];for(var b=0,c=a.length;b<c;++b)VIa(this.i,a[b])}this.V("handlerOpened")};
...
g.k.DC=function(a){"S"==a[0]?this.W=a[1]:"gracefulReconnect"==a[0]?(this.l.start(),TIa(this.i)):this.V("handlerMessage",new dJa(a[0],a[1]))};
...
g.k.hQ=function(){this.l.isActive();0==WIa(this.i)&&this.connect(this.C,this.B)};D5.prototype.B=function(a,b,c,d){b?a(d):a({text:c.responseText})};
D5.prototype.u=function(a,b){a(Error("Request error: "+b.status))};
D5.prototype.C=function(a){a(Error("request timed out"))};var mJa=g.C(),G5=null,J5=Array(50),I5=-1,K5=!1;g.Ra(L5,g.Q);L5.prototype.Rg=function(){return this.screens};
...
g.k.GJ=function(a){this.i=null;a.status&&404==a.status?this.l>=CKa.length?this.V("pairingFailed",Error("DIAL polling timed out")):(a=CKa[this.l],this.gb=g.zo((0,g.B)(this.ZF,this),a),this.l++):this.V("pairingFailed",Error("Server error "+a.status))};
g.k.IJ=function(){this.i=null;this.V("pairingFailed",Error("Server not responding"))};
var CKa=[2E3,2E3,1E3,1E3,1E3,2E3,2E3,5E3,5E3,1E4];g.Ra(O5,L5);g.k=O5.prototype;g.k.start=function(){N5(this)&&this.V("screenChange");!g.Fu("yt-remote-lounge-token-expiration")&&qJa(this);g.Bo(this.i);this.i=g.zo((0,g.B)(this.start,this),1E4)};
g.k.add=function(a,b){N5(this);nJa(this,a);P5(this,!1);this.V("screenChange");b(a);a.token||qJa(this)};
g.k.remove=function(a,b){var c=N5(this);pJa(this,a)&&(P5(this,!1),c=!0);b(a);c&&this.V("screenChange")};
...
g.k.Dz=function(){g.Bo(this.u);this.u=NaN;this.l&&this.l.abort();var a=sJa(this);if(x4(a)){var b=E5(this.C,"/pairing/get_screen_availability");this.l=F5(this.C,b,{lounge_token:g.Hb(a).join(",")},(0,g.B)(this.SO,this,a),(0,g.B)(this.RO,this))}else T5(this,{}),U5(this)};
g.k.SO=function(a,b){this.l=null;var c=g.Hb(sJa(this));if(g.wb(c,g.Hb(a))){c=b.screens||[];for(var d={},e=0,f=c.length;e<f;++e)d[a[c[e].loungeToken]]="online"==c[e].status;T5(this,d);U5(this)}else this.Fd("Changing Screen set during request."),this.Dz()};
...
g.k.JJ=function(a,b,c,d){g.Yp(E5(this.B,"/pairing/get_screen"),{method:"POST",postParams:{pairing_code:a},timeout:5E3,onSuccess:(0,g.B)(function(e,f){var h=new B4(f.screen||{});if(!h.name||wJa(this,h.name)){a:{var l=h.name;for(var m=2,n=b(l,m);wJa(this,n);){m++;if(20<m)break a;n=b(l,m)}l=n}h.name=l}c(W5(this,h))},this),
...
g.k.yL=function(){yJa(this);this.V("screenChange");this.i.update()};
...
g.k.da=function(){this.Oz("");Y5.Dd.da.call(this)};g.u(a6,Y5);g.k=a6.prototype;g.k.Nz=function(a){if(this.l){if(this.l==a)return;$5(this,"Overriding cast session with new session object");GJa(this);this.ea=!1;this.W="unknown";this.l.removeUpdateListener(this.Y);this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ca)}this.l=a;this.l.addUpdateListener(this.Y);this.l.addMessageListener("urn:x-cast:com.google.youtube.mdx",this.ca);CJa(this,"getMdxSessionStatus")};
...
g.k.Oz=function(){};
g.k.da=function(){this.info("disposeInternal");GJa(this);this.l&&(this.l.removeUpdateListener(this.Y),this.l.removeMessageListener("urn:x-cast:com.google.youtube.mdx",this.ca));this.l=null;Y5.prototype.da.call(this)};
g.k.EP=function(a,b){if(!this.na())if(b){var c=V4(b);if(g.Ma(c)){var d=""+c.type;c=c.data||{};this.info("onYoutubeMessage_: "+d+" "+g.Oj(c));switch(d){case "mdxSessionStatus":AJa(this,c);break;case "loungeToken":DJa(this,c);break;default:$5(this,"Unknown youtube message: "+d)}}else $5(this,"Unable to parse message.")}else $5(this,"No data in message.")};
g.k.DD=function(a,b,c,d){g.Bo(this.L);this.L=0;vJa(this.B,this.i.label,a,this.i.friendlyName,(0,g.B)(function(e){e?b(e):0<=d?($5(this,"Screen "+a+" appears to be offline. "+d+" retries left."),this.L=g.zo((0,g.B)(this.DD,this,a,b,c,d-1),300)):c(Error("Unable to fetch screen."))},this),c)};
...
g.k.uy=function(a){this.W=F4();if(this.Y){var b=new chrome.cast.DialLaunchResponse(!0,IJa(this));a(b);HJa(this)}else this.J=(0,g.B)(function(){g.Bo(this.I);this.J=g.Ia;this.I=NaN;var c=new chrome.cast.DialLaunchResponse(!0,IJa(this));a(c);HJa(this)},this),this.I=g.zo((0,g.B)(function(){this.J()},this),100)};
g.k.OL=function(a,b,c){vJa(this.B,this.L.receiver.label,a,this.i.friendlyName,(0,g.B)(function(d){d&&d.token?(Z5(this,d),b(new chrome.cast.DialLaunchResponse(!1))):this.uy(b,c)},this),(0,g.B)(function(d){$5(this,"Failed to get DIAL screen: "+d);
...
g.k.da=function(){this.l.unsubscribe("onlineScreenChange",(0,g.B)(this.FB,this));window.chrome&&chrome.cast&&chrome.cast.removeReceiverActionListener(this.I);var a=gJa,b=g.Ha("yt.mdx.remote.debug.handlers_");g.ib(b||[],a);g.Ni(this.i);g.Q.prototype.da.call(this)};
...
g.k.FB=function(){this.na()||(this.u=KJa(this),g6("Updating custom receivers: "+g.Oj(this.u)),chrome.cast.setCustomReceivers(this.u,g.Ia,(0,g.B)(function(){this.Fd("Failed to set custom receivers.")},this)),this.V("yt-remote-cast2-availability-change",h6(this)))};
...
g.k.da=function(){WJa(this);this.u=null;this.B.clear();A6(this,null);g.Q.prototype.da.call(this)};
...
g.k.yr=function(a){H5("CP","Cast media: "+!!a);this.i&&this.i.removeUpdateListener(this.J);if(this.i=a)this.i.addUpdateListener(this.J),XJa(this),this.V("remotePlayerChange")};
g.k.aN=function(a){a?(XJa(this),this.V("remotePlayerChange")):this.yr(null)};
g.k.iA=function(){H6(this,"sendDebugCommand",{debugCommand:"stats4nerds "})};
g.k.iN=function(){var a=TJa();a&&A6(this,a)};
...
params:g.Oj(l)},a,bIa())}else K6("Connecting without params"),this.i.connect({},a,bIa());ZJa(this)};
...
bKa(this,a);break;case "loungeScreenDisconnected":g.jb(this.l,function(c){return"LOUNGE_SCREEN"==c.type});
bKa(this,!1);break;case "remoteConnected":var b=new A4(V4(a.params.device));g.$a(this.l,function(c){return b?c.id==b.id:!1})||MHa(this.l,b);
break;case "remoteDisconnected":b=new A4(V4(a.params.device));g.jb(this.l,function(c){return b?c.id==b.id:!1});
break;case "gracefulDisconnect":break;case "playlistModified":dKa(this,a);break;case "nowPlaying":fKa(this,a);break;case "onStateChange":eKa(this,a);break;case "onAdStateChange":gKa(this,a);break;case "onVolumeChanged":hKa(this,a);break;case "onSubtitlesTrackChanged":cKa(this,a);break;case "nowAutoplaying":iKa(this,a);break;case "autoplayDismissed":this.V("autoplayDismissed");break;case "autoplayUpNext":this.I=a.params.videoId||null;this.V("autoplayUpNext",this.I);break;case "onAutoplayModeChanged":this.B=
a.params.autoplayMode;this.V("autoplayModeChange",this.B);"DISABLED"==this.B&&this.V("autoplayDismissed");break;case "onHasPreviousNextChanged":jKa(this,a);break;case "requestAssistedSignIn":this.V("assistedSignInRequested",a.params.authCode);break;default:K6("Unrecognized action: "+a.action)}};
...
g.k.ro=function(a){K6("Disconnecting with "+a);M6(this);this.V("beforeDisconnect",a);1==a&&M4();fJa(this.i,a);this.dispose()};
...
g.k.mQ=function(a,b){P6(this,a,b);aKa(this)};
...
g.k.MN=function(){g.Mb(this.B)||uKa(this,this.B);this.C=!1};
...
g.k.rH=function(){var a=this;if(k7(this)){var b=C6(this.wb);this.events.Gb(this.X);b.muted?this.G.mute():this.G.unMute();this.G.setVolume(b.volume);this.X=this.events.N(this.G,"onVolumeChange",function(c){sKa(a,c)})}};
...
g.k.tb=function(a){this.u.stop();var b=this.I;if(!g.AK(b,a)){var c=g.V(a,2);c!==g.V(this.I,2)&&this.G.Bn(c);this.I=a;wKa(this.l,b,a)}};g.u(n7,g.W);n7.prototype.Ec=function(){this.i.show()};
...
g.k.load=function(){this.player.cancelPlayback();g.HN.prototype.load.call(this);this.nh=new j7(this,this.player,this.wb);var a=(a=rKa())?a.currentTime:0;var b=g7()?new B6(a7(),void 0):null;0==a&&b&&(a=x6(C6(b)));0!==a&&this.Bb(a);wKa(this,this.Mc,this.Mc);this.player.Ej(6)};
...
g.k.EF=function(){var a=[this.gi],b=a.concat,c=oKa();p6()&&g.Fu("yt-remote-cast-available")&&c.push({key:"cast-selector-receiver",name:"Cast..."});this.Ml=b.call(a,c);a=b7()||this.gi;t7(this,a);this.player.xa("onMdxReceiversChange")};
